...
cat("Loading...\n")
df <- nanoparquet::read_parquet(paste0(OUT,"unified2_panel.parquet"))
...
write_csv(ladder, paste0(OUT,"unified2_reg_ladder.csv"))
...
write_csv(ctrls_df, paste0(OUT,"unified2_reg_controls.csv"))
...
write_csv(rob, paste0(OUT,"unified2_reg_robustness.csv"))
cat(sprintf("Robustness: %d rows\n", nrow(rob)))

# ====== 4. noT3 SENSITIVITY ======
cat("\n=== 4. noT3 Sensitivity ===\n")
# Rebuild panel excluding Tier3 gvkeys from notice data
panel_base <- nanoparquet::read_parquet(paste0(OUT,"unified2_panel_base.parquet"))
...
write_csv(noT3, paste0(OUT,"unified2_reg_ladder_noT3.csv"))
...
write_csv(wA, paste0(OUT,"unified2_reg_ladder_w2005_2017.csv"))
...
write_csv(cf, paste0(OUT,"unified2_reg_carryforward.csv"))
...
write_csv(cor_df, paste0(OUT,"unified2_correlations.csv"))
